...
( function ( exports, he_1 ) {
    ...
    var HTMLElement = /** @class */ ( function ( _super ) {
        ...
        HTMLElement.prototype.remove = function ( el, childNodes ) {
            //var o = 0;
            if ( !childNodes ) {
            ...
            for ( let i = 0, l = childNodes.length; i < l; i++ ) {
                ...
                if ( node.tagName === el.tagName ) {
                    if ( ( node._rawAttrs.name && node._rawAttrs.name === el._rawAttrs.name )
                        || ( node._rawAttrs.id && node._rawAttrs.id === el._rawAttrs.id ) ) {
