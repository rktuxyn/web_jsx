...
public:
	__forceinline image() {
		...
		_gd_is_init = FALSE; _format = image_format::UNKNOWN;
		_gdiplus_token = NULL; _is_copy = FALSE;
	}
	__forceinline ~image() {
		this->release_all();
	}
...
void image_export(v8::Isolate* isolate, v8::Handle<v8::Object> target){
	...
	v8::Local<v8::Context>context = isolate->GetCurrentContext();
	{
		...
		image_format_object->Set(context, v8_str(isolate, "BMP"), v8::Integer::New(isolate, (int)image_format::BMP));
		image_format_object->Set(context, v8_str(isolate, "PNG"), v8::Integer::New(isolate, (int)image_format::PNG));
		image_format_object->Set(context, v8_str(isolate, "JPEG"), v8::Integer::New(isolate, (int)image_format::JPEG));
		image_format_object->Set(context, v8_str(isolate, "JPG"), v8::Integer::New(isolate, (int)image_format::JPG));
		image_format_object->Set(context, v8_str(isolate, "GIF"), v8::Integer::New(isolate, (int)image_format::GIF));
		image_format_object->Set(context, v8_str(isolate, "TIFF"), v8::Integer::New(isolate, (int)image_format::TIFF));
		image_format_object->Set(context, v8_str(isolate, "TIF"), v8::Integer::New(isolate, (int)image_format::TIF));
		target->Set(context, v8_str(isolate, "image_format"), image_format_object);

		v8::Local<v8::Object>image_mood = v8::Object::New(isolate);
		image_mood->Set(context, v8_str(isolate, "READ"), v8::Integer::New(isolate, (int)_mood::READ));
		image_mood->Set(context, v8_str(isolate, "WRITE"), v8::Integer::New(isolate, (int)_mood::WRITE));
		target->Set(context, v8_str(isolate, "image_mood"), image_mood);
	}
	target->Set(context, v8_str(isolate, "Image"), image_tpl->GetFunction(isolate->GetCurrentContext()).ToLocalChecked());
}
#endif//!_WIN32||_WIN64
